...
let cost = yogaPrice * 3 + workoutPrice * 2;
const AlexBudget = totalBudget - cost;
...
const packageCoursePrice = 2520;
const coursePrice = 180;
const discount = 0.9;
...
const teamCoursePrice = 150;
let machineUsePriceTotal = machineUsePrice * 3;
let groupClassesTotal = teamCoursePrice * 2;
...
let b = 0; // 宣告一個 b 的變數，並賦予了一個 0 的數字型別
a = 13; // 賦予 a 新值為 13 的數字型別
a = b + 4; // 答案 a = 4 ; 將 0 + 4 的值 給 a 變數
a - b; // 將 a值 4 減去 b值 0
b += 1; //答案 b ＝ 1 ; 將 b值 +1 賦值 給 b 變數
...
/* 
輸出：[5,10,15,20],[25, 30, 35]

宣告 numberArr1 為 一個包含 5,10,15 的陣列;

宣告 numberArr2 並 引用參考 numberArr1 即 同個記憶體位置，同為[5, 10, 15];

將 numberArr2 [5,10,15] 使用 push 方法在陣列最後一個位置 加入 20 的值，得到[5,10,15,20]
並且等同於同時修改了 numberArr1 陣列為 [5,10,15,20];

將 numberArr2 賦予新的值為 [25, 30, 35] 

得到的結果為 console.log([5,10,15,20],[25, 30, 35]);
*/
